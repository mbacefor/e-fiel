...
public class EmpresaResourceIntTest {
     ...
     *
     * @see br.com.efiel.repository.search.EmpresaSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createEmpresa() throws Exception {
        ...
        assertThat(testEmpresa.getFone()).isEqualTo(DEFAULT_FONE);
    ...
    public void updateEmpresa() throws Exception {
        ...
        assertThat(testEmpresa.getFone()).isEqualTo(UPDATED_FONE);
